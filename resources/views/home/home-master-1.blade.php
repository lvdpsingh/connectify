        ...
        <section id="hero" class="flex">
            ...
            <div id="heroCarousel" class="carousel slide carousel-fade" >
                ...
                <div class="carousel-inner" >
                    ...
                    <!-- Slide 1 -->
                    <div class="carousel-item active" style="background-image: url({{asset('logo/slide-iot-3.jpg')}});">
                        <div class="carousel-container">

                            <div class="carousel-content align-center">
                                <h2>Welcome to <span>Connectify</span></h2>
                                <p>Welcome to Connectify, a leading provider of internet communication solutions. With a rich history dating back several decades, Connectify has become the largest and most geographically diverse internet communications company in the United States. Our team of over 6,400 dedicated professionals work tirelessly to provide reliable and affordable internet services to more than 14 million customers across 24 states. At Connectify, we believe that access to the internet is essential to help keep our customers' lives flowing, which is why we are committed to providing safe, secure, and high-speed internet services to our customers. For more information about our services, please visit our website at connectify.com and follow us on Twitter, Facebook, Instagram, and LinkedIn.</p>
